...
PAGE 0 :
   ...
   RAML5      : origin = 0x00D000, length = 0x000800
...
SECTIONS
{
   ...
   .pinit           : > RAML0,     PAGE = 0
   .switch          : > RAML0,     PAGE = 0
   .text2			: LOAD = RAML1, RUN = RAML5, LOAD_START(_funcLoadStart), LOAD_END(_funcLoadEnd), RUN_START(_funcRunStart), LOAD_SIZE(_funcLoadSize), PAGE = 0
